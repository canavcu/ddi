...
<FORM METHOD="POST" enctype="multipart/form-data;charset=UTF-8">
    ...
    <ul>
        <li><a href="#tabs-1">Zemberek DEASCII Demo</a></li>
        <li><a href="#tabs-2">Zemberek DEASCII Dosya</a></li>
   ...
   <form:form action="zemdeascii/out" modelAttribute="uploadItem" METHOD="POST" enctype="multipart/form-data" accept-charset="UTF-8">
